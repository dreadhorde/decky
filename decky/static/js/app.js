$(function () {
  ...
  $('.save-deck').click(function(event) {
    event.preventDefault();
    $('.save-deck').html('<div class="btn-loader">&nbsp;</div>').width(88.15).addClass('c');
  ...
  $('.tooltip').hover(function(e) {
    ...
    // This if statement is terrible
    if($(this).hasClass('foil')) {
      $('body').append('<div class="card-preview foil"><img src="https://img.scryfall.com/cards/large/front/' + this.t[0] + '/' + this.t[1] + '/' + this.t + '.jpg"/></div>');
    } else {
      $('body').append('<div class="card-preview"><img src="https://img.scryfall.com/cards/large/front/' + this.t[0] + '/' + this.t[1] + '/' + this.t + '.jpg"/></div>');
    }
  ...
  $('.builder-table tbody').on('mouseenter', '.tooltip', function(e) {
    // Card tooltips
    this.t = $(this).attr('data-img');
    // This if statement is still terrible
    if($(this).hasClass('foil')) {
      $('body').append('<div class="card-preview foil"><img src="https://img.scryfall.com/cards/large/front/' + this.t[0] + '/' + this.t[1] + '/' + this.t + '.jpg"/></div>');
    } else {
      $('body').append('<div class="card-preview"><img src="https://img.scryfall.com/cards/large/front/' + this.t[0] + '/' + this.t[1] + '/' + this.t + '.jpg"/></div>');
